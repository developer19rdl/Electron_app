...
const ReportUserList = () => {
    ...
    const DownloadCsv = async () => {
        ...
        // 3. Add data rows (Updated to show 0 instead of blank)
            ...
            headers.slice(1).forEach((header) => {
                if (header.subHeaders) {
                    header.subHeaders.forEach((subHeader) => {
                        ...
                        // If value is null, undefined, or an empty string, show 0
                        row.push((value !== undefined && value !== null && value !== '') ? value : 0);
                    });
                } else {
        ...
        worksheet.eachRow((row) => {
            row.eachCell((cell) => {
                ...
                // Optional: Format as number if the value is 0
                if (cell.value === 0) {
                    cell.numFmt = '0';
                }
            });
